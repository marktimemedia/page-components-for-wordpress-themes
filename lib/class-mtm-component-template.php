 ...
 *
 * @package   Mtm_Component_Templates
    ...
    class Mtm_Component_Templates {
            ...
            public static function get_instance() {
                    ...
                    if( null == self::$instance ) {
                            self::$instance = new Mtm_Component_Templates();
                    } 
            ...
            private function __construct() {
                    ...
                    if ( version_compare( floatval( get_bloginfo( 'version' ) ), '4.7', '<' ) ) {
                        ...
                        add_filter(
                            ...
                            array( $this, 'mtm_register_project_templates' )
                        );
                        ...
                        add_filter(
                            'theme_page_templates', array( $this, 'mtm_add_new_template' )
                        );
                    ...
                    add_filter(
    					'template_include', 
    					array( $this, 'mtm_view_project_template') 
    				);
            ...
            public function mtm_register_project_templates( $atts ) {
