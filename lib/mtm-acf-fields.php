...
acf_add_local_field_group(array (
	...
	'fields' => array (
		...
		array (
			'key' => 'field_568313d27680c',
			'label' => 'Featured Content Box Default Image',
			'name' => 'mtm_home_featured_content_default_image',
			'type' => 'image',
			'instructions' => '(Optional) Add a default image to be used if your selected content does not have a featured image',
			'required' => 0,
			'conditional_logic' => array (
				array (
					array (
