			...
			'fields' => array(
				...
				array(
					...
					'layouts' => apply_filters( 'mtm_content_modules_layouts_filter', array(
						...
						$this->mtm_module_hero_media,
						$this->mtm_module_slider,
						$this->mtm_module_feature_boxes,
						$this->mtm_module_call_to_action,
						$this->mtm_module_logo_showcase,
						$this->mtm_module_widget_area,
						$this->mtm_module_listgrid,
